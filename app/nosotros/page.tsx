...
import { Shield, Clock, Award, Hammer, Lock } from "lucide-react"
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#0F2A4A] to-[#1B5FA8] py-16 text-white text-center">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-gray-200 text-lg max-w-2xl mx-auto">
            Seguridad bancaria, precisión técnica y confidencialidad. Conozca nuestra trayectoria y compromiso con el resguardo de sus cajeros automáticos (ATM).
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-[#0F2A4A] to-[#1B5FA8] p-8 rounded-3xl text-white shadow-xl relative overflow-hidden flex flex-col justify-between min-h-[300px]">
              ...
              <div className="relative z-10">
                <span className="text-xs font-bold uppercase tracking-wider text-[#9CE0FF] block mb-3">Nuestra Misión</span>
              ...
              <div className="relative z-10 border-t border-white/10 pt-6">
                <p className="text-xs text-gray-300 italic">&ldquo;Garantizamos aperturas técnicas limpias y seguras en sistemas de bóvedas bancarias de todas las marcas.&rdquo;</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <h3 className="font-heading text-2xl font-bold text-keytek-text">
                Profesionales certificados con estrictos protocolos
              </h3>
              ...
              <p className="text-keytek-text-muted text-sm leading-relaxed">
                Nuestros especialistas cuentan con certificaciones vigentes y capacitación continua en la manipulación, reprogramación y apertura de cerraduras digitales con retardo y marcas líderes del mercado financiero como Kaba Mas (Cencon), Sargent & Greenleaf, y La Gard.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4 mt-2">
                <div className="p-4 rounded-xl bg-keytek-bg-soft border border-gray-100 flex items-center gap-3">
                  ...
                  <span className="text-xs font-bold text-keytek-text">Técnicos Homologados</span>
                </div>
                <div className="p-4 rounded-xl bg-keytek-bg-soft border border-gray-100 flex items-center gap-3">
                  <Lock className="h-5 w-5 text-keytek-blue shrink-0" />
                  <span className="text-xs font-bold text-keytek-text">Confidencialidad Total</span>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-keytek-text-muted text-sm md:text-base">
              Nos enfocamos en tres principios clave para entregar la mejor experiencia corporativa en seguridad bancaria.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center flex flex-col items-center">
              ...
              <h3 className="font-heading text-lg font-bold text-keytek-text mb-2">Respuesta Logística</h3>
              <p className="text-keytek-text-muted text-xs md:text-sm leading-relaxed">
                Coordinamos de manera directa con las mesas de ayuda bancarias y empresas de valores para dar soporte técnico en todo Chile.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center flex flex-col items-center">
              ...
              <h3 className="font-heading text-lg font-bold text-keytek-text mb-2">Técnicas No Destructivas</h3>
              <p className="text-keytek-text-muted text-xs md:text-sm leading-relaxed">
                Utilizamos métodos técnicos de precisión para abrir bóvedas de cajeros sin dañar la estructura física del dispositivo.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm text-center flex flex-col items-center">
              ...
              <h3 className="font-heading text-lg font-bold text-keytek-text mb-2">Seguridad y Rigor</h3>
              <p className="text-keytek-text-muted text-xs md:text-sm leading-relaxed">
                Precios transparentes y apego estricto a las normas de seguridad del cliente bancario en cada intervención.
              </p>
            </div>
      ...
      <section className="bg-gradient-to-r from-[#0F2A4A] to-[#1B5FA8] py-12 text-white text-center">
        <div className="container mx-auto px-4 max-w-3xl">
          <h3 className="font-heading text-2xl font-bold mb-4">¿Tiene dudas sobre nuestros servicios o cobertura?</h3>
          <p className="text-gray-300 text-sm mb-6">Estamos a su entera disposición. Escríbanos directamente para cotizaciones o requerimientos especiales.</p>
          <a
            href={`https://wa.me/${phoneRaw}?text=${encodeURIComponent("Hola, necesito realizar una consulta sobre soporte técnico para cajeros automáticos.")}`}
            target="_blank"
